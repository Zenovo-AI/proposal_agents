...
//   <button
//     onClick={async () => {
//       if (uploading || !!docLink) return // Prevent double clicks or re-upload
...
//       }
//     }}
//     disabled={uploading || !!docLink}  // Disable button during upload or after success
//     style={{ opacity: uploading || !!docLink ? 0.5 : 1, cursor: uploading || !!docLink ? "not-allowed" : "pointer" }}
//   >
//     📄 Upload Approved Proposal to Google Docs
//   </button>
// )}
...
//                     onClick={async () => {
//                       const lastUserMessage = messages.findLast(msg => msg.role === "user")
//                       if (!lastUserMessage?.content || !currentState) {
//                         console.log("Missing lastUserMessage content or currentState", lastUserMessage, currentState);
//                         return;
//                       }
                                      
//                       setUploading(true)
//                       const link = await uploadToGoogleDocs(lastUserMessage.content, currentState)
//                       setUploading(false)
